                ...
                return Row(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Image.asset(
                          'assets/icons/ri.png', // static for now
                          width: 24,
                          height: 24,
                        ),
                      ),
...
// import 'package:flutter_bloc/flutter_bloc.dart';
// import 'package:go_router/go_router.dart';
// import 'package:pikquick/features/wallet/data/model/transaction_model.dart';
// import 'package:pikquick/features/wallet/presentation/wallet_bloc.dart';
// import 'package:pikquick/features/wallet/presentation/wallet_event.dart';
// import 'package:pikquick/features/wallet/presentation/wallet_state.dart';
// import 'package:pikquick/router/router_config.dart';
...
//                 TextButton(
//                   onPressed: () {
//                     context.go(MyAppRouteConstant.task);
//                   },
//                   child: const Text(
//                     "See All",
//                     style: TextStyle(
...
//               ),
//             );
//           } else if (state is TransactionHistorySucessState) {
//             final transactions = state.transactionHistory;
...
//                             children: [
//                               Text(
//                                 transaction.userId ?? 'Date not available',
//                                 style: TextStyle(
//                                   fontSize: 12,
//                                   color: Colors.grey[600],
//                                   fontFamily: 'Outfit',
...
//           earningRow("Pending Earning", "₦50,000"),
//           const SizedBox(height: 10),
//           earningRow("Withdrawal Balance", "₦50,000"),
//           const SizedBox(height: 10),
//           const Divider(),
//           const SizedBox(height: 10),
//           earningRow("All-time Earning", "₦50,000"),
//         ],
//       ),
//     );
//   }

//   Row earningRow(String label, String amount) {
//     return Row(
//       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//       children: [
//         Text(label, style: const TextStyle(fontFamily: 'Outfit', fontSize: 14)),
//         Text(
//           amount,
//           style: const TextStyle(
//             fontWeight: FontWeight.bold,
...
//           Row(
//             children: [
//               walletButton("+ Add Funds", MyAppRouteConstant.addfunds),
//               const SizedBox(width: 10),
//               walletButton("Request Payout", MyAppRouteConstant.requestpayout),
//             ],
//           ),
//         ],
//       ),
...
//   Expanded walletButton(String text, String route) {
//     return Expanded(
//       child: SizedBox(
//         height: 40,
//         child: ElevatedButton(

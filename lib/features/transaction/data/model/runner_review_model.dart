...
class RunnerReviewModel extends RunnerReviewEntity {
  ...
  factory RunnerReviewModel.fromJson(Map<String, dynamic> json) {
    return RunnerReviewModel(
  ...
  factory RunnerReviewModel.fromEntity(ClientReviewEntity entity) {
    return RunnerReviewModel(

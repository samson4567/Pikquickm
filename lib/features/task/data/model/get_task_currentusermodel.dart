...
class GetTaskForClientModel extends GetTaskForCurrenusersEntity {
  const GetTaskForClientModel({
    super.id,
    super.runnerName,
    super.description,
    super.budget,
  ...
  factory GetTaskForClientModel.fromJson(Map<String, dynamic> json) {
    return GetTaskForClientModel(

...
class CreateRunnerAccount extends StatefulWidget {
  const CreateRunnerAccount({super.key});

  @override
  State<CreateRunnerAccount> createState() => _CreateRunnerAccountState();
}

class _CreateRunnerAccountState extends State<CreateRunnerAccount> {
  ...
  final List<String> _roles = ['runner'];

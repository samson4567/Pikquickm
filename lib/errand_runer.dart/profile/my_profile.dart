...
import 'package:pikquick/errand_runer.dart/profile/ultis.dart';
...
class _MyProfileState extends State<MyProfile> {
  ...
  Future<void> selectedImage() async {
    ...
    // ✅ Pass the actual picked file path
    final profileUploadModel =
        ProfileUploadModel(message: '', filePath: picked.path);

    context
        .read<ProfileBloc>()
        .add(ProfileUploadFileEvent(profileUpload: profileUploadModel));
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProfileBloc, ProfileState>(
      listener: (context, state) {
        ...
        } else if (state is ProfileUploadErrorState) {
          ScaffoldMessenger.of(context).showSnackBar(
                          ...
                          children: [
                            ...
                            FancyContainer(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  context.pushNamed(
                                      MyAppRouteConstant.profilempty);
                                },
                                child: const Text(
                                  'Edit Profile',
                                  style: TextStyle(
        ...
        return Row(
          ...
          children: const [
            ...
            Flexible(
              child: Text(
                '| 0% cancellation rate',
                style: TextStyle(fontSize: 10, letterSpacing: 0.3, height: 1.4),
